...
namespace org.Tayou.AmityEdits {
    internal class DepthActionSlider : BaseField<Vector2> {
        ...
        public DepthActionSlider(SerializedProperty prop, DepthActionUnits units) : base(null,null) {
            ...
            var test = new Label(units == DepthActionUnits.Plugs ? "Fully\n\u2193 Inserted" : units == DepthActionUnits.Local ? "Tip inside\n\u2193 1 local-unit" : "Tip\n\u2193 inside 1m");
            ...
            var test3 = new Label(units == DepthActionUnits.Plugs ? "Tip 3 plug-lengths\naway \u2193" : units == DepthActionUnits.Local ? "Tip 3 local-units\naway \u2193" : "Tip 3m\naway \u2193");
